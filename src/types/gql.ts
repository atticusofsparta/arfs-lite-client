...
import { gqlTagNameRecord } from "src/constants";
...
export const edgesFragment = (singleResult: boolean) => `
	edges {
		${singleResult ? "" : "cursor"}
		${nodeFragment}
	}
...
export const latestResult = 1;
export const pageLimit = 100;

export type Sort = typeof ASCENDING_ORDER | typeof DESCENDING_ORDER;

export const gqlTagNameArray = gqlTagNameRecord
  ? Object.values(gqlTagNameRecord)
  : [];
